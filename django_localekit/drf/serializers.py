...
from .fields import AutoTranslatableJsonField, GetTextCharField


def _get_field_translation_dict(instance, field_name) -> dict[str, str]:
...
class BaseTranslatableSerializer(serializers.ModelSerializer):
    ...
    @abstractmethod
    def get_field_translation(self, instance, field_name) -> Union[str, None, dict[str, str]]:
        """
...
class TranslatableDBSerializer(BaseTranslatableSerializer):
    ...
    def get_field_translation(self, instance, field_name) -> Union[str, None]:
...
class TranslatableDBDictSerializer(BaseTranslatableSerializer):
    ...
    def get_field_translation(self, instance, field_name) -> dict[str, str]:
        return _get_field_translation_dict(instance, field_name)
